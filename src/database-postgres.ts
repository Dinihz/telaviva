...
export class DatabasePostgres {
  ...
  async create(film: { name: string, author: string, description?: string, release_date?: string }) {
  ...
  async update(name: string, film: { name?: string, author?: string, description?: string, release_date?: string }) {
    const fields: string[] = []
    const values: any[] = []
